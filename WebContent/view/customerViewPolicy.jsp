	...
	<div id="policy-details">
		...
		<table>
			<tr>
				...
				<td class="tbl-data"><%=session.getAttribute("policyId")%></td>
			</tr>
			<tr>
				<td class="tbl-labels">Policy Name</td>
				<td class="tbl-data"><%=policy.getPolicyName()%></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td class="tbl-data"><%=policy.getTenure()%> Year(s)</td>
			</tr>
			<tr>
				<td class="tbl-labels">Sum Assured</td>
				<td class="tbl-data">$<%=policy.getSumAssured()%></td>
			</tr>
			<tr>
